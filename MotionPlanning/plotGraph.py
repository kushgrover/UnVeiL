...
plot_file(dir_together + "obstacles.csv", "red", False, 1)
...
plot_file(dir_together + "end-finalpath.csv", "orange", False, 2)
plot_file(dir_together + "obstacles.csv", "red", False, 1)
plot_file(dir_together + "labels.csv", "black", True, 0)
plot_last_point(dir_together + "end-movement.csv", "#33e026")
plot_last_point(dir_together + "end-finalpath.csv", "orange")
...
plot_file(dir_separate + "obstacles.csv", "red", False, 1)
...
plot_file(dir_separate + "end-finalpath.csv", "orange", False, 2)
plot_file(dir_separate + "obstacles.csv", "red", False, 1)
plot_file(dir_separate + "labels.csv", "black", True, 0)
